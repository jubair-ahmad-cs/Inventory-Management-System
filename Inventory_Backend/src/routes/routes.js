...
router.route('/customer').get(verifyToken, getAllCustomers).post(verifyToken, createCustomer);
router.route('/customer/:id').get(verifyToken, getCustomerById).put(verifyToken, updateCustomer).delete(verifyToken, deleteCustomer);
